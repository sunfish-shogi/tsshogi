...
`;
  ...
  it("import/handicap-initial-position", () => {
    const data = `
#KIF version=2.0 encoding=Shift_JIS
# ---- Kifu for Windows V7 V7.70 棋譜ファイル ----
開始日時：2023/09/08 22:12:16
手合割：角落ち　
上手の持駒：歩　
  ９ ８ ７ ６ ５ ４ ３ ２ １
+---------------------------+
...
上手：
手数----指手---------消費時間--
   1 ３八銀(39)   ( 0:00/00:00:00)
   2 ２二銀(31)   ( 0:00/00:00:00)
   3 ６八銀(79)   ( 0:00/00:00:00)
   4 ６二銀(71)   ( 0:00/00:00:00)
   5 ７六歩(77)   ( 0:00/00:00:00)
   6 ８六歩(85)   ( 0:00/00:00:00)
   7 同　歩(87)   ( 0:00/00:00:00)
   8 同　飛(82)   ( 0:00/00:00:00)
   9 ８七歩打     ( 0:00/00:00:00)
  10 ８二飛(86)   ( 0:00/00:00:00)
  11 ６六歩(67)   ( 0:00/00:00:00)
  12 ２三歩打     ( 0:00/00:00:00)
  13 ２八飛(24)   ( 0:00/00:00:00)
  14 ７四歩(73)   ( 0:00/00:00:00)
  15 ６七銀(68)   ( 0:00/00:00:00)
  16 ７二金(61)   ( 0:00/00:00:00)
`;
    const record = importKIF(data) as Record;
    expect(record).toBeInstanceOf(Record);
    expect(record.getUSI({ allMoves: true })).toBe(
      "position sfen lnsg1gsnl/1r4k2/p1ppppp1p/7R1/1p7/9/PPPPPPP1P/1BG6/LNS1KGSNL b Pp 1 moves 3i3h 3a2b 7i6h 7a6b 7g7f 8e8f 8g8f 8b8f P*8g 8f8b 6g6f P*2c 2d2h 7c7d 6h6g 6a7b",
    );
  });
...
&開始局面
   ...
   4 ８五歩(84)   ( 0:02/00:00:04)
   5 ７八金(69)   ( 0:05/00:00:10)
   6 ３二金(41)   ( 0:02/00:00:06)
   7 ３八銀(39)   ( 0:03/00:00:13)
   8 ７二銀(71)   ( 0:02/00:00:08)
&基本図
   9 ５八玉(59)   ( 0:33/00:00:46)
  10 ５二玉(51)   ( 0:02/00:00:10)
  11 ７六歩(77)   ( 0:02/00:00:48)
  12 ８六歩(85)   ( 0:02/00:00:12)
  13 同　歩(87)   ( 0:02/00:00:50)
  14 同　飛(82)   ( 0:02/00:00:14)
  15 ２四歩(25)   ( 0:02/00:00:52)
  16 同　歩(23)   ( 0:01/00:00:15)
  17 同　飛(28)   ( 0:03/00:00:55)
  18 ２三歩打     ( 0:05/00:00:20)
  19 ２六飛(24)   ( 0:02/00:00:57)
  20 ３四歩(33)   ( 0:02/00:00:22)
  21 ８七歩打     ( 0:03/00:01:00)
  22 ８四飛(86)   ( 0:02/00:00:24)
  23 ３六歩(37)   ( 0:07/00:01:07)
  24 ７四歩(73)   ( 0:01/00:00:25)
  25 ２四歩打     ( 0:02/00:01:09)
*25手目のコメント
&途中図
  26 同　歩(23)   ( 0:05/00:00:30)
  27 同　飛(26)   ( 0:02/00:01:11)
  28 ７五歩(74)   ( 0:02/00:00:32)
  29 同　歩(76)   ( 0:07/00:01:18)
  30 ２三歩打     ( 0:02/00:00:34)
  31 ２五飛(24)   ( 0:01/00:01:19)
...
`;
    ...
    record.goto(1);
    expect(record.current.bookmark).toBe("");
    record.goto(8);
    expect(record.current.bookmark).toBe("基本図");
    expect(record.current.comment).toBe("");
    record.goto(25);
...
手合割：平手
手数----指手---------消費時間--
   1 ７六歩(77)   ( 0:08/00:00:08)
   2 ３四歩(33)   ( 0:12/00:00:12)
*2手目へのコメント
*2手目へのコメント2
   3 ２二角成(88) ( 0:15/00:00:23)
   4 同　銀(31)   ( 0:03/00:00:15)+
   5 ４五角打     ( 0:06/00:00:29)
   6 中断         ( 0:00/00:00:15)

変化：4手
   4 同　飛(82)   ( 0:05/00:00:17)
   5 投了         ( 0:07/00:00:30)
`,
    );
  });
  ...
  it("export/with-comment", () => {
    const record = new Record();
    record.append(record.position.createMoveByUSI("7g7f") as Move);
    expect(exportKIF(record, { comment: "written by TypeScript\nenjoy shogi" })).toBe(
...
`,
  ...
  it("export/bookmark", () => {
    ...
    record.current.comment = "3手目のコメント";
    record.append(record.position.createMoveByUSI("3a2b") as Move);
    record.append(record.position.createMoveByUSI("B*4e") as Move);
...
`,
  ...
  it("export/start-position", () => {
    const testCases = [
      { sfen: InitialPositionSFEN.STANDARD, want: "手合割：平手" },
      { sfen: InitialPositionSFEN.HANDICAP_LANCE, want: "手合割：香落ち" },
      {
        sfen: InitialPositionSFEN.HANDICAP_RIGHT_LANCE,
        want: "手合割：右香落ち",
      },
      { sfen: InitialPositionSFEN.HANDICAP_BISHOP, want: "手合割：角落ち" },
      { sfen: InitialPositionSFEN.HANDICAP_ROOK, want: "手合割：飛車落ち" },
      {
        sfen: InitialPositionSFEN.HANDICAP_ROOK_LANCE,
        want: "手合割：飛香落ち",
      },
      { sfen: InitialPositionSFEN.HANDICAP_2PIECES, want: "手合割：二枚落ち" },
      { sfen: InitialPositionSFEN.HANDICAP_4PIECES, want: "手合割：四枚落ち" },
      { sfen: InitialPositionSFEN.HANDICAP_6PIECES, want: "手合割：六枚落ち" },
      { sfen: InitialPositionSFEN.HANDICAP_8PIECES, want: "手合割：八枚落ち" },
      { sfen: InitialPositionSFEN.HANDICAP_10PIECES, want: "手合割：十枚落ち" },
      {
        sfen: "lnsgk2nl/4r1g2/1Ppp1ps1p/pR7/4p4/2P6/P1BPPPP1P/2S1KSG2/LN1G3NL w 2Pb2p 1",
        want: `後手の持駒：歩二　角　
  ９ ８ ７ ６ ５ ４ ３ ２ １
+---------------------------+
|v香v桂v銀v金v玉 ・ ・v桂v香|一
...
先手番`,
    ...
    for (const tc of testCases) {
      ...
      expect(exportKIF(record, {})).toBe(`${tc.want}\n手数----指手---------消費時間--\n`);
    }
  });
...
▲５八飛    △８四歩    ▲７六歩    △８五歩    ▲７七角    △３四歩
▲６六歩    △６二銀    ▲１六歩    △４二玉    ▲４八玉    △３二玉
▲３八玉    △５四歩    ▲７八銀    △３三角    ▲６八飛    △４二角
▲１五歩    △８六歩    ▲同　歩    △同　角    ▲同　角    △同　飛
▲７七角    △８二飛    ▲６五歩    △２二銀    ▲８三歩    △同　飛
▲６四歩    △５二金右  ▲２二角成  △同　玉    ▲７二銀    △８二飛
▲６三歩成  △同　銀    ▲同　銀不成△４二金寄  ▲８三歩    △同　飛
▲５四銀不成△５六歩    ▲同　歩    △５三歩    ▲４五銀    △８七歩
▲６二飛成  △８八歩成  ▲３四銀    △７八と    ▲４三銀不成△５一銀
▲４二銀不成△同　銀    ▲４三銀    △５一銀打  ▲４二銀不成△同　銀
▲５二金    △同　金    ▲同　龍    △５一金    ▲４三銀    △４一銀
▲７二龍    △８九飛成  ▲５九金左  △４五角    ▲６三歩    △９四角
▲８三歩    △７六角    ▲５五金    △５七桂    ▲４五金    △４九桂成
▲６六角    △３三歩    ▲４九金    △同　龍    ▲２八玉    △５八龍
▲４八桂    △６九龍    ▲８一龍    △６六龍    ▲４二銀不成△同　銀
▲６二銀    △４九角成  ▲３四桂    △同　歩    ▲５一龍    △３九馬
▲同　玉    △６九龍    ▲４九金    △５一銀    ▲同　銀不成△７六角
▲５五角    △４四歩    ▲３八銀    △１六桂    ▲４四角    △３三銀
▲同　角成  △同　桂    ▲１六香    △１八金    ▲１七銀    △７九飛
▲５九桂    △４五桂    ▲１四歩    △同　歩    ▲６二銀成  △１九角
▲１四香    △２八銀    ▲同　銀    △同　金
まで124手で後手の勝ち
`);
  });
