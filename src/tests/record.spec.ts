...
`;
    ...
    expect(handler.mock.calls[1][0].displayText).toBe("☖８四歩");
    ...
    expect(handler.mock.calls[2][0].displayText).toBe("☗７五歩");
    expect(handler.mock.calls[3][0].displayText).toBe("☖４四歩");
    expect(handler.mock.calls[4][0].displayText).toBe("☗２六歩");
    expect(handler.mock.calls[5][0].displayText).toBe("☗７八金");
    expect(handler.mock.calls[6][0].displayText).toBe("☖３四歩");
    expect(handler.mock.calls[7][0].displayText).toBe("☗７六歩");
...
`;
  ...
  it("getSubtree", () => {
    const data = `表題：横歩取り7手目２四歩
戦型：横歩取り
編集ツール：ShogiHome
手合割：平手
▲２六歩    △３四歩    ▲７六歩    △８四歩    ▲２五歩    △８五歩
▲２四歩    △同　歩    ▲同　飛    △３二金    ▲５八玉    △８六歩
▲同　歩    △同　飛    ▲２二角成  △同　銀    ▲７七角    △８二飛
▲８三歩    △５二飛    ▲７八銀    △７二金    ▲４八金    △５四歩
▲３六歩    △８三金    ▲３七桂    △７四金    ▲７五歩    △同　金
▲４五桂    △２三歩    ▲７二歩    △同　銀    ▲３四飛    △３三歩
▲３五飛    △７四歩    ▲９五角    △７三角    ▲同　角成  △同　銀
▲７七桂    △４四角    ▲５三角

変化：30手
△６四金    ▲２二角成  △同　金    ▲５三銀    △８二飛    ▲６四銀成
△同　歩    ▲８三歩    △５二飛    ▲４五桂    △２三銀    ▲２九飛
△２四歩    ▲６三金

変化：22手
△５四歩    ▲４八金    △５五歩    ▲３六歩    △２三銀    ▲２七飛
△２四歩    ▲３七金    △３三桂    ▲４六金

変化：14手
△８八角成  ▲同　銀    △３三角    ▲２一飛成  △８八角成  ▲２四桂
△２二馬    ▲３二桂成  △同　飛    ▲２二龍    △同　銀    ▲６六角

変化：12手
△８八角成  ▲同　銀    △３三角
*この形では成立しない
▲２一飛成  △８八角成  ▲７七角    △同　馬    ▲同　桂    △８六歩
▲６五桂
*先手勝勢
...
変化：10手
△８八角成  ▲同　銀    △３三角    ▲２八飛    △２七歩    ▲５八飛
△８六歩    ▲同　歩    △同　飛    ▲７八金    △７六飛    ▲９八角
△８八角成  ▲同　金    △７九飛成  ▲６九角    △７五龍

変化：14手
△２六歩    ▲７七桂    △２二飛    ▲３八銀    △７二金    ▲４六歩
△７七角成  ▲同　銀    △２七桂    ▲６六角    △１九桂成  ▲２二角成
△同　銀    ▲６六角`;
    const record = importKI2(data) as Record;
    record.goto(12);
    record.switchBranchByIndex(1); // △８八角成

    const subtree = record.getSubtree();

    expect(subtree).toBeDefined();
    expect(exportKI2(subtree)).toBe(`表題：横歩取り7手目２四歩
戦型：横歩取り
編集ツール：ShogiHome
後手の持駒：歩　角　
  ９ ８ ７ ６ ５ ４ ３ ２ １
